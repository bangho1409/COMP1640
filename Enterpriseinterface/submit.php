      ...
      <div class="wrapper">
        <section class="post">
          ...
          <form action="#" onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions and Privacy Policy'); return false; }">
            ...
            <textarea placeholder="Your idea's title" spellcheck="false" class="content" required></textarea>

            <textarea placeholder="Your idea's content" spellcheck="false" class="description" required></textarea>
            ...
            <div class="options">
              ...
              <input type="checkbox" required name="checkbox"value="check" id="agree" /> I have read and agree to the <a href="term.html" target="_blank">Terms and Conditions and Privacy Policy</a>
            <button>Post</button>
          </form>
