...
<div class="w3-top">
  <div class="w3-bar w3-red w3-left-align w3-card w3-large">
    ...
    <a href="login.html" class="w3-bar-item w3-display-topright w3-button w3-hide-small w3-padding-large w3-hover-white w3-gray">Login</a>
  </div>
...
<header class="w3-container w3-opacity-min w3-center" style="padding:128px 16px">
  ...
  <a href= "submit.html" class="w3-button w3-black w3-padding-large w3-large w3-margin-top">Submit your idea</a>
</header>
...
<div class="w3-row-padding w3-padding-32 w3-container">
  <div class="w3-content">
    <a href= "idea.html" class="w3-twothird w3-light-gray w3-container">
      <!-- Title -->
